...
@section('content')
<!-- Hero Section -->
<div class="relative bg-gradient-to-r from-blue-600 to-indigo-700 dark:from-gray-800 dark:to-gray-900 overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div class="text-center">
            <h1 class="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                <span class="block">Encuentra tu próximo</span>
                <span class="block text-indigo-200">trabajo ideal</span>
            </h1>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 mb-8 backdrop-blur-sm bg-opacity-90 dark:bg-opacity-90">
        <form action="{{ route('public.job-postings.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="flex items-end">
                <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition duration-150 ease-in-out flex items-center justify-center">
