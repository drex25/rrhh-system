...
<div class="w-full mx-auto bg-white p-8 rounded shadow">
    <h2 class="text-2xl font-bold mb-6 text-gray-800">Nueva Posición</h2>
    <form action="{{ route('positions.store') }}" method="POST" class="space-y-6">
        @csrf
        <div>
            <label class="block text-sm font-medium text-gray-700">Título *</label>
            <input type="text" name="title" value="{{ old('title') }}" class="mt-1 block w-full rounded border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="number" step="0.01" name="min_salary" value="{{ old('min_salary') }}" class="mt-1 block w-full rounded border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
            ...
            <div>
                ...
                <input type="number" step="0.01" name="max_salary" value="{{ old('max_salary') }}" class="mt-1 block w-full rounded border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
        ...
        <div>
            ...
            <textarea name="responsibilities" rows="2" class="mt-1 block w-full rounded border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('responsibilities') }}</textarea>
