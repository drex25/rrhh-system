...
<aside class="fixed z-30 inset-y-0 left-0 transition-all duration-300 ease-in-out" :class="sidebarCollapsed ? 'w-20' : 'w-72'">
    <div :class="darkMode ? 'bg-[#181F2A] border-[#232B3E]' : 'bg-gray-100 border-gray-200'" class="flex flex-col h-screen overflow-y-auto border-r sidebar-pro" style="scrollbar-width: none;">
        <div :class="darkMode ? 'bg-[#232B3E] border-[#232B3E]' : 'bg-gray-200 border-gray-200'" class="flex items-center justify-center h-20 border-b sidebar-logo">
        ...
        <nav class="flex-1 px-2 py-6 space-y-2">
            ...
            @php
                ...
                $baseClasses = 'flex items-center rounded-none font-semibold transition-all duration-200 group relative border-l-4';
                $activeClasses = $isActive ? 'border-blue-500 bg-blue-50 text-blue-900 dark:bg-[#181F2A] dark:text-white' : 'border-transparent text-blue-900 hover:bg-blue-100 dark:text-white dark:hover:bg-[#232B3E]';
            @endphp
            <a href="/dashboard"
            ...
            <a href="{{ route('payslips.index') }}"
               :class="[
                  'flex items-center rounded-none transition-all duration-200 group relative border-l-4',
                  sidebarCollapsed ? 'justify-center px-0 py-3 border-l-0' : 'gap-4 px-4 py-3',
                  darkMode
                    ? 'hover:bg-[#232B3E] text-white border-blue-500'
                    : 'hover:bg-blue-100 text-blue-900 border-blue-500'
               ]"
               x-data="{ tooltip: false }"
               @mouseenter="if(sidebarCollapsed) tooltip = true"
               @mouseleave="tooltip = false">
            ...
            <div x-data="{ open: false }">
                <button @click="open = !open"
                        :class="[
                           'flex items-center w-full rounded-none transition-all duration-200 group relative border-l-4',
                           sidebarCollapsed ? 'justify-center px-0 py-3 border-l-0' : 'gap-4 px-4 py-3',
                           darkMode
                ...
                <div x-show="open && !sidebarCollapsed" x-transition class="pl-10 space-y-1 border-l-2 border-[#232B3E] ml-2">
                    <a href="{{ route('documents.index') }}" :class="darkMode ? 'text-white hover:text-blue-400' : 'text-blue-900 hover:text-blue-400'" class="flex items-center gap-2 py-2 text-sm">
                        <span class="w-2 h-2 bg-blue-400 rounded-full inline-block"></span> Documentos
                    </a>
                    <a href="{{ route('academic-history.index') }}" :class="darkMode ? 'text-white hover:text-blue-400' : 'text-blue-900 hover:text-blue-400'" class="flex items-center gap-2 py-2 text-sm">
                        <span class="w-2 h-2 bg-blue-400 rounded-full inline-block"></span> Historial Académico
                    </a>
                    <a href="{{ route('training.index') }}" :class="darkMode ? 'text-white hover:text-blue-400' : 'text-blue-900 hover:text-blue-400'" class="flex items-center gap-2 py-2 text-sm">
                        <span class="w-2 h-2 bg-blue-400 rounded-full inline-block"></span> Capacitación
                    </a>
                    <a href="{{ route('performance.index') }}" :class="darkMode ? 'text-white hover:text-blue-400' : 'text-blue-900 hover:text-blue-400'" class="flex items-center gap-2 py-2 text-sm">
            ...
            <div x-data="{ open: false }">
                ...
                <div x-show="open && !sidebarCollapsed" x-transition class="pl-10 space-y-1 border-l-2 border-[#232B3E] ml-2">
                    <a href="{{ route('job-postings.index') }}" :class="darkMode ? 'text-white hover:text-blue-400' : 'text-blue-900 hover:text-blue-400'" class="flex items-center gap-2 py-2 text-sm">
                        <span class="w-2 h-2 bg-blue-400 rounded-full inline-block"></span> Vacantes
                    </a>
                    <a href="{{ route('candidates.index') }}" :class="darkMode ? 'text-white hover:text-blue-400' : 'text-blue-900 hover:text-blue-400'" class="flex items-center gap-2 py-2 text-sm">
            ...
            <div x-data="{ open: false }">
                ...
                <div x-show="open && !sidebarCollapsed" x-transition class="pl-10 space-y-1 border-l-2 border-[#232B3E] ml-2">
                    <a href="{{ route('reports.index') }}" :class="darkMode ? 'text-white hover:text-blue-400' : 'text-blue-900 hover:text-blue-400'" class="flex items-center gap-2 py-2 text-sm">
                        <span class="w-2 h-2 bg-blue-400 rounded-full inline-block"></span> Reportes
                    </a>
                    <a href="{{ route('analytics.index') }}" :class="darkMode ? 'text-white hover:text-blue-400' : 'text-blue-900 hover:text-blue-400'" class="flex items-center gap-2 py-2 text-sm">
