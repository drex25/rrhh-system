...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $departments = [
            'Recursos Humanos' => Department::create([
        ...
        $positions = [
            ...
            'Desarrollador Senior' => Position::create([
            ...
            'Desarrollador Junior' => Position::create([
            ...
            'Analista de RRHH' => Position::create([
