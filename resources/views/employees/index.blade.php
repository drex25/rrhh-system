...
@section('content')
<div class="w-full mx-auto px-4 md:px-6 lg:px-8 py-6 bg-gray-100 dark:bg-[#181F2A] min-h-screen">
    <!-- Header -->
    <div class="flex flex-col md:flex-row items-center justify-between bg-gray-200 dark:bg-[#232B3E] rounded-2xl shadow-lg p-8 mb-8 border border-gray-200 dark:border-[#232B3E]">
        <div class="flex items-center gap-4 mb-4 md:mb-0">
            <div class="p-3 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl shadow-lg">
                <i class="fa-solid fa-users text-2xl text-white"></i>
            </div>
            <div>
                <h1 class="text-3xl md:text-4xl font-extrabold text-blue-900 dark:text-white tracking-tight">Empleados</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1">Gestión de personal</p>
            </div>
        </div>
    ...
    <!-- Filtros -->
    <div class="bg-gray-200 dark:bg-[#232B3E] rounded-xl shadow-lg p-6 mb-8 border border-gray-200 dark:border-[#232B3E]">
        <form action="{{ route('employees.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="relative group">
                <label for="search" class="block text-sm font-medium text-blue-900 dark:text-gray-300 mb-2">Buscar</label>
                <div class="relative">
                    <input type="text" name="search" id="search" value="{{ request('search') }}" 
                        class="w-full pl-10 pr-4 py-2.5 border border-gray-300 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-200 dark:bg-[#232B3E] text-blue-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition-all duration-200 group-hover:border-blue-400" 
                        placeholder="Nombre, legajo, DNI...">
                    <i class="fa-solid fa-magnifying-glass absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400 group-hover:text-blue-500 transition-colors"></i>
                </div>
            </div>
            <div class="group">
                <label for="department" class="block text-sm font-medium text-blue-900 dark:text-gray-300 mb-2">Departamento</label>
                <select name="department" id="department" 
                    class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-200 dark:bg-[#232B3E] text-blue-900 dark:text-white transition-all duration-200 group-hover:border-blue-400 tom-select">
            ...
            <div class="group">
                <label for="status" class="block text-sm font-medium text-blue-900 dark:text-gray-300 mb-2">Estado</label>
    ...
    <!-- Tabla -->
    <div class="bg-gray-200 dark:bg-[#232B3E] rounded-2xl shadow-lg overflow-hidden border border-gray-200 dark:border-[#232B3E]">
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-300 dark:divide-gray-700">
                <thead class="sticky top-0 z-10 bg-gray-200 dark:bg-[#232B3E] border-b border-gray-200 dark:border-[#232B3E]">
                    <tr>
                        <th scope="col" class="px-6 py-4 text-left text-xs font-bold text-blue-900 dark:text-gray-300 uppercase tracking-wider">Legajo</th>
                        <th scope="col" class="px-6 py-4 text-left text-xs font-bold text-blue-900 dark:text-gray-300 uppercase tracking-wider">Nombre</th>
                        <th scope="col" class="px-6 py-4 text-left text-xs font-bold text-blue-900 dark:text-gray-300 uppercase tracking-wider">Departamento</th>
                        <th scope="col" class="px-6 py-4 text-left text-xs font-bold text-blue-900 dark:text-gray-300 uppercase tracking-wider">Puesto</th>
                        <th scope="col" class="px-6 py-4 text-left text-xs font-bold text-blue-900 dark:text-gray-300 uppercase tracking-wider">Estado</th>
                        <th scope="col" class="px-6 py-4 text-center text-xs font-bold text-blue-900 dark:text-gray-300 uppercase tracking-wider">Acciones</th>
                    </tr>
                </thead>
                <tbody class="bg-gray-200 dark:bg-[#232B3E] divide-y divide-gray-300 dark:divide-gray-700">
                    @forelse($employees as $employee)
                        <tr class="hover:bg-gray-300 dark:hover:bg-[#232B3E]/80 transition-all duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-blue-900 dark:text-white">{{ $employee->first_name }} {{ $employee->last_name }}</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-blue-900 dark:text-gray-300">{{ $employee->department->name }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-blue-900 dark:text-gray-300">{{ $employee->position->title }}</td>
                            <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-8 text-center">
                                <div class="flex flex-col items-center justify-center text-gray-600 dark:text-gray-400">
                                    <i class="fa-solid fa-users text-4xl mb-3 text-gray-500 dark:text-gray-600"></i>
        ...
        <div class="px-6 py-4 bg-gray-200 dark:bg-[#232B3E] border-t border-gray-200 dark:border-[#232B3E] flex justify-center">
